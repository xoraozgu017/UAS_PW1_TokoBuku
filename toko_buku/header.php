...
<head>
	...
	<title>TOKO ONLINE BUKU SHOP TERBAIK</title>
				...
				<div class="pull-right">
					<ul class="header-btns">
						...
						if(!is_null($_SESSION['keranjang'])){
        					...
        					// Mengecek apakah array $i['produk_harga'] ada dan bernilai tetap atau bukan
        					if(isset($i['produk_harga'])){
												...
												if ($i != null) {
													...
													<div class="product product-widget">
														<div class="product-thumb">
															...
															<?php } else { ?>
																<img src="gambar/produk/1.jpg<?php echo $i['produk_foto1'] ?>">
															<?php } ?>
														</div>
